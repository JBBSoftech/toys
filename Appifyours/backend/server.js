...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/toys_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '69b3f44f52c5d1d8699efcb8',
      shopName: 'Toys',
...
app.listen(PORT, () => {
  console.log(`Toys Backend Server running on port ${PORT}`);
});
